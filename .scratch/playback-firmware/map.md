...
- [Implement A2DP Speaker Link functionality](issues/08-implement-speaker-link.md) is claimed.
- Scheduler, engine, recovery, and application bootstrap remain blocked by their listed dependencies.
