...
- one constrained fast-start `video.mp4` with an H.264 video track;
- one independent `audio.mp3` plus `audio.idx` that Playback decodes to PCM for the Speaker Link;
